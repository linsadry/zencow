export const PETS_INIT = [
  { id:1, nome:"Rasta",     raca:"SRD",              sexo:"M", nascimento:"", foto:null, peso:"",
    ...
    consultas:[],exames:[],medicamentos:[],banhos:[{id:1,data:"20/05/2025"}],gastos:[],galeria:[] },
...
export const AGENDA_INIT = [
  {id:1,titulo:"Consulta glaucoma",hora:"09:00",durMin:60, cor:"#C4654A",bg:"#F5EAE5",dia:0},
  {id:2,titulo:"Questões RFB",     hora:"14:00",durMin:90, cor:"#C4654A",bg:"#F5EAE5",dia:0},
  {id:3,titulo:"Banho do Bento",   hora:"16:00",durMin:30, cor:"#6A8FAA",bg:"#E5EFF5",dia:0},
  {id:4,titulo:"Vacina Rasta",     hora:"10:00",durMin:30, cor:"#6A8FAA",bg:"#E5EFF5",dia:3},
];
