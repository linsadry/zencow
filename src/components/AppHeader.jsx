  ...
  return (
    <div style={{ display:"flex",alignItems:"center",justifyContent:"space-between",
      ...
      <div style={{ display:"flex",alignItems:"center",gap:7 }}>
        {showLogo && (
          <img src={LOGO} alt="" style={{ width:25,height:25,borderRadius:7,objectFit:"cover" }}/>
        )}
        <span className="serif" style={{ fontSize: showLogo ? 22 : 18, fontWeight:700,
          color: showLogo ? T.terra : T.text, letterSpacing:-.3 }}>{title}</span>
      </div>
