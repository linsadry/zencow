  ...
  return (
    ...
    >
      ...
      >
        {/* Cabeçalho */}
        <div style={{
          padding: "52px 20px 18px", borderBottom: `1px solid ${T.border}`,
          ...
          <div>
            <div className="serif" style={{ fontWeight: 700, fontSize: 20, color: T.terra, letterSpacing: -0.3 }}>
              ZenCow
            </div>
  ...
  return (
    <div style={{
      ...
      {TABS.map((t) => {
        ...
        const handleClick = () => t.id === "mais" ? openMore() : onSelect(t.id);
        ...
        {items.map((it) => (
          ...
          >
            <div style={{
              ...
              background: it.cor + "22",
              display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0,
            }}>
              <img src={COW_IMG[it.id]} alt="" style={{ width: 38, height: 38, objectFit: "contain" }} />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div className="serif" style={{ fontSize: 17, fontWeight: 700, color: T.text }}>
                {it.label}
              </div>
              <div style={{ fontSize: 11, color: T.textMute, fontStyle: "italic", marginTop: 1 }}>
                com {it.nome}
              </div>
